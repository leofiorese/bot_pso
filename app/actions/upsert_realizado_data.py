...
TABLE_COLUMNS = [
    ...
    "DURACAO_PREVISTA_HORAS", "TRABALHO_APONTADO_ATIVIDADE", "TRABALHO_FALTANDO_ATIVIDADE", "TRABALHO_PREVISTO_ATIVIDADE",
    "CODIGO_PROJETO", "DT_FIM_PROJETO", "DT_INICIO_PROJETO", "NOME_PROJETO", "VALOR_PROJETO", "HORAS", "CUSTO_APONT"
]

CREATE_TABLE_SQL = """
CREATE TABLE IF NOT EXISTS `RELATORIO_PSO_REALIZADO` (
    `APON_ID` INT,
    `USU_ID` INT,
    `ATIVO` BOOLEAN,
    `EMAIL` VARCHAR(255),
...
UPSERT_SQL = """
INSERT INTO RELATORIO_PSO_REALIZADO (
  APON_ID, USU_ID, ATIVO, EMAIL, NOME_USUARIO, ATIV_ID,
  DT_INICIO_APONTAMENTO, PROJ_ID, TX_COLABORADOR, NOME_ATIVIDADE,
  B_DT_FIM_ATIVIDADE, B_DT_INICIO_ATIVIDADE, DT_FIM_ATIVIDADE, DT_INICIO_ATIVIDADE,
  DURACAO_PREVISTA_HORAS,TRABALHO_APONTADO_ATIVIDADE, TRABALHO_FALTANDO_ATIVIDADE, TRABALHO_PREVISTO_ATIVIDADE,
  ...
  %(DURACAO_PREVISTA_HORAS)s,%(TRABALHO_APONTADO_ATIVIDADE)s, %(TRABALHO_FALTANDO_ATIVIDADE)s, %(TRABALHO_PREVISTO_ATIVIDADE)s,
