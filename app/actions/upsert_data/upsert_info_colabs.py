...
CREATE_TABLE_SQL = """
CREATE TABLE IF NOT EXISTS `INFO COLABS` (
    `USU_ID` INT,
    `NOME` VARCHAR(255),
    `SIGLA` VARCHAR(50),
    `LOGIN` VARCHAR(255),
    ...
    `IND_BANCO_HORAS` VARCHAR(1),
    `IND_APONTAMENTO_HORAS` VARCHAR(1),
    `DT_BANCO_HORAS` DATE,
...
UPSERT_SQL = """
INSERT INTO `INFO COLABS` (
    USU_ID, NOME, SIGLA, LOGIN, EMAIL, ATIVO, USU_ID_SUPERIOR, EMP_ID, FORN_ID, CR_ID, CPF, RG, TELEFONE, ENDERECO, SEXO,
    DADOS_PAGAMENTO, OBS, TAXA_ID, TAXA_ID_HORARIA, TAXA_ID_HORARIA_2, TAXA_ID_CUS_MENSAL, TAXA_ID_CUS, TAXA_ID_CUS_2,
    ...
    %(DADOS_PAGAMENTO)s, %(OBS)s, %(TAXA_ID)s, %(TAXA_ID_HORARIA)s, %(TAXA_ID_HORARIA_2)s, %(TAXA_ID_CUS_MENSAL)s, %(TAXA_ID_CUS)s, %(TAXA_ID_CUS_2)s,
