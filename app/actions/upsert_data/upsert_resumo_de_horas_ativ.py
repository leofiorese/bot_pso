...
TABLE_COLUMNS = [
    "RESHRATI_ID", "RESHR_ID", "ATRIB_ID", "DIA1", "DIA2", "DIA3",
    "DIA4", "DIA5", "DIA6", "DIA7", "DT_INCLUSAO", "DT_ALTERACAO"
]

TABLE_NAME = "RESUMO_DE_HORAS_ATIV"
PK_COLUMNS = ["RESHRATI_ID"]
...
def upsert_data(df: pd.DataFrame, table_name: str, csv_file_path: str):
    bulk_upsert(
        ...
        archive_func=arquivar_csv, archive_name="RESUMO DE HORAS ATIV",
    )
